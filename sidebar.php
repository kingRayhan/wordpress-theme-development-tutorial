				...
				<div class="w3ls_popular_posts">
					...
					<div class="agileits_popular_posts_grid">
						<div class="w3agile_special_deals_grid_left_grid">
							<a href="singlepage.html"><img src="<?php echo get_template_directory_uri(); ?>/images/p1.jpg" class="img-responsive" alt="" /></a>
						</div>
					...
					<div class="agileits_popular_posts_grid">
						<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="<?php echo get_template_directory_uri(); ?>/images/p2.jpg" class="img-responsive" alt="" /></a>
							</div>
					...
					<div class="agileits_popular_posts_grid">
						<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="<?php echo get_template_directory_uri(); ?>/images/p3.jpg" class="img-responsive" alt="" /></a>
						</div>
			...
			<div class="w3ls_recent_posts">
					...
					<div class="agileits_recent_posts_grid">
						<div class="agileits_recent_posts_gridl">
							<div class="w3agile_special_deals_grid_left_grid">
									<a href="singlepage.html"><img src="<?php echo get_template_directory_uri(); ?>/images/r1.jpg" class="img-responsive" alt="" /></a>
								</div>
						</div>
					...
					<div class="agileits_recent_posts_grid">
						<div class="agileits_recent_posts_gridl">
							<div class="w3agile_special_deals_grid_left_grid">
									<a href="singlepage.html"><img src="<?php echo get_template_directory_uri(); ?>/images/r2.jpg" class="img-responsive" alt="" /></a>
								</div>
						</div>
						<div class="agileits_recent_posts_gridr">
					...
					<div class="agileits_recent_posts_grid">
						<div class="agileits_recent_posts_gridl">
							<div class="w3agile_special_deals_grid_left_grid">
									<a href="singlepage.html"><img src="<?php echo get_template_directory_uri(); ?>/images/r3.jpg" class="img-responsive" alt="" /></a>
								</div>
						</div>
						<div class="agileits_recent_posts_gridr">
